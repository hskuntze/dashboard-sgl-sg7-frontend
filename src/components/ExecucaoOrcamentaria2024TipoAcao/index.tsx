...
const ExecucaoOrcamentaria2024TipoAcao = () => {
  ...
  const options: ApexOptions = {
    ...
    colors: ["#445125", "#E23114"], // Cores para cada série
    legend: {
      position: "bottom",
    },
  };
...
export default ExecucaoOrcamentaria2024TipoAcao;
