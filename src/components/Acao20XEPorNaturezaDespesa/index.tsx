...
const Acao20XEPorNaturezaDespesa = () => {
  ...
  const loadData = useCallback(() => {
    ...
    const requestParams: AxiosRequestConfig = {
      url: "/acao20xe/execucao/natureza",
      method: "GET",
  ...
  const options: ApexOptions = {
    ...
    colors: ["#0520FA", "#8905FA", "#056EFA", "#5F407A", "#5F407A", "#05ACFA", "#5E97FA"], // Cores para cada série
    legend: {
      position: "bottom",
    },
  };
...
export default Acao20XEPorNaturezaDespesa;
