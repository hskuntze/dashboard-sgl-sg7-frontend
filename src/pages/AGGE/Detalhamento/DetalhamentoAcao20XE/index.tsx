...
import Acao20XECard from "components/Acao20XECard";
...
const DetalhamentoAcao20XE = () => {
  const [loading, setLoading] = useState(false);
  const [page, setPage] = useState<SpringPage<Acao20XEType>>();
  ...
  return (
    <div className="list-container">
      <h2 style={{ marginLeft: "10px", marginTop: "20px" }}>Ação 20XE - MANUTENÇÃOO E MODERNIZAÇÃO DE SISTEMAS DE COMANDO E CONTROLE</h2>
      <div>
        ...
        <table className="table-container">
          <thead className="table-head">
            <tr>
              ...
              <th scope="col">Cód. Nat. Despesa</th>
              <th scope="col">Nome Nat. Despesa</th>
              <th scope="col">Código Elemento Despesa</th>
              <th scope="col">Nome Elemento Despesa</th>
              <th scope="col">Provisão Recebida</th>
              <th scope="col">Crédito Disponível</th>
              <th scope="col">Despesa Empenhada</th>
              <th scope="col">Despesa Liquidada</th>
              <th scope="col">Despesa Paga</th>
            </tr>
          </thead>
          <tbody className="table-body">
            {page?.content.map((el) => (
              <Acao20XECard element={el} key={el.codigo} />
            ))}
          </tbody>
          <tfoot>
            <tr>
...
export default DetalhamentoAcao20XE;
