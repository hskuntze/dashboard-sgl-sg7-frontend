...
const UsuarioList = () => {
  ...
  const filteredData = usuarios.filter((u) => {
    ...
    return (
      u.nomecompleto.toLowerCase().includes(searchTerm) ||
      (u.cpf.toLowerCase().includes(searchTerm) ?? false) ||
  ...
  const handleExportPDF = () => {
    ...
    filteredData?.forEach((u, i) => {
      ...
      doc.text(u.nomecompleto, marginLeft, y);
      y += lineHeight;
      ...
      const data = [
        ...
        ["Organização", u.organizacao ? u.organizacao : ""],
        ["Telefone", u.telefone],
  ...
  return (
    <>
      <div className="top-list-buttons">
        <Link to="/dashboard-sgl-sg7/usuario/inserir">
